...
function accelerate_child_scripts(){
    ...
    // wp_enqueue_style( 'accelerate-google-fonts', '//fonts.googleapis.com/css?family=Londrina+Solid');
}
...
// Create new class for contact-us page
...
// Initiate widgets for accelerate sidebar
